...
run 60_base "$BASE"
drop clas6_pi0       61_drop_clas6_pi0
drop clas6_eta       62_drop_clas6_eta
drop halla_n         63_drop_halla_n
drop halla_y16       64_drop_halla_y16
drop halla_y11       65_drop_halla_y11
drop bsa_demasi_phi  66_drop_bsa_demasi
drop bsa_zhao        67_drop_bsa_zhao
drop bsa_clas12      68_drop_bsa_clas12
drop eg1             69_drop_eg1
$PY compare_runs.py > runs/COMPARISON.txt 2>&1
echo "### $(date +%H:%M:%S)  SERIES 4 DONE"
