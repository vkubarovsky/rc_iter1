...
$n/p$ rests on four neutron points and is not measured; one polarised-target
...
\]
The $n/p$ ratio is quoted with a warning; see section~\ref{sec:notmeasured}.
...
\section{What the data do not determine}
\label{sec:notmeasured}

This section is the point of the exercise, and is stated as plainly as the
numbers allow.

\paragraph{$n/p$ is not measured.}  It rests on four neutron points with
uncertainties of 42 to 90\,\%.  Remove them and $n/p$ goes from $1.06$ to
$2.15$; nothing else in the database constrains it.  During one day of
otherwise minor and justified changes --- correcting systematics, adding a
normalisation nuisance, repairing a parameter bound --- the fitted value moved
through $1.00$, $1.02$, $0.98$, $1.04$, $1.06$ while $\chi^2/\mathrm{ndf}$
changed in the third decimal.
